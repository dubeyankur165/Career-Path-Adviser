...
/* <?php include './Intelligent Career Guidance_files/bootstrap.min.css' ?>
<?php include './Intelligent Career Guidance_files/css' ?> */
						...
						<div class="col-md-8">
							...
							<?php
								...
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									...
									<a class="main-button icon-button" href="login/login.php">Get Started!</a>
			...
			<div class="container">
				...
				<div class="row">
					<div class="section-header text-center">
						...
						<h2 style="margin-top: 100px; font-size: 45px;">Welcome</h2>
						...
						<p class="lead"><b style="color: rgb(56, 48, 48);">We help you understand yourself, the best career choices for you <br> and providing all the resources in the process.</p>
					</div>
				</div>	
						...
						<div class="feature">
							...
							<div class="feature-content">
								...
								if(!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true):?>
									...
									<a href="login/login.php">Career Prediction</a>
								<?php else: ?>
		...
		<div id="contact-cta" class="section" style="height: 400px;">
			...
			<div class="bg-image bg-parallax overlay" style="background-image:url(contact-us-background.jpg)"></div>
			<!-- Backgound Image -->
